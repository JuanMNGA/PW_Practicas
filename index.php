    ...
    for($dim_actual = 1; $dim_actual <= $num_dim; $dim_actual++){
      ...
      for($i = 0; $i < mysql_num_rows($preguntas); $i++ ){
          ...
          switch($pregunta_actual["tipo"]){
            case 1:
              echo "<select name=\"pregunta$i+1\" class=\"form-control\"><br><option value=\"1\">PAS<option value=\"2\">Profesor<option value=\"3\" checked>Estudiante</select><br>";
            break;
            case 2:
              $estudios = obtener_estudios();
              $num_estudios = mysql_num_rows($estudios);
              echo "<select name=\"pregunta$i+1\" class=\"form-control\"><br>";
            ...
            break;
            case 3:
              echo "<select name=\"pregunta$i+1\" class=\"form-control\"><br><option value=\"1\">Biblioteca CASEM<option value=\"2\">Biblioteca ESI</select><br>";
            break;
            case 4:
              echo "<select name=\"pregunta$i+1\" class=\"form-control\"><br><option value=\"1\" checked>Hombre<option value=\"2\">Mujer</select><br>";
            break;
            case 5:
              echo "<select name=\"pregunta$i+1\" class=\"form-control\"><br><option value=\"1\" checked>0";
              for($j=1;$j<10;$j++){
            ...
            break;
            case 6:
              echo "<select name=\"pregunta$i+1\" class=\"form-control\"><br><option value=\"1\" checked>18-24<option value=\"2\">25-31<option value=\"3\">32-60</select><br>";
            break;
            case 7:
